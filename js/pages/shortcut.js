const shortcut = {
    ...
    <div class='py-container'> \
        <div class='shortcut'> \
            <ul class='fl'> \
               <li class='f-item'>Njtech-Shop欢迎您！</li> \
           ...
           <ul class='fr'> \
               ...
               <li class='f-item'><a href='home.html' target='_blank'>我的Njtech-Shop</a></li> \
               <li class='f-item space'></li> \
               <li class='f-item'>Njtech-Shop会员</li> \
               <li class='f-item space'></li> \
               <li class='f-item'>企业采购</li> \
               <li class='f-item space'></li> \
               <li class='f-item'>关注Njtech-Shop</li> \
               <li class='f-item space'></li> \
